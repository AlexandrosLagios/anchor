...
| 5 | 1:50 | Eleni | In the group, write "Dad, remember to take your pills with you when we leave in the morning." | Only Nikos sees "⏰ Eleni wrote: «Dad, remember to take your pills…» Shall I remind you?", with "Yes, at 08:00", "Another time", "No thanks", and "Stop offering reminders". He taps "Yes, at 08:00". The offer turns into "Done ✍ I'll remind you at 08:00 in our private chat.", and Eleni's message gets a ✍. The family sees only the ✍: the pills stay private. |
...
Beat 5 uses the sentence of the design, because Anchor offers a reminder only for a clear future action with a time or a trigger. The rehearsals must show the offer both times.
