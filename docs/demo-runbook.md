...
| --- | --- | --- | --- | --- |
| 1 | 0:00 | Nikos | In the group, write "Anchor, can you send me family photos?" | Only Nikos sees Anchor's answer: "Nikos, I can send you family moments, reminders, and voice notes in private. Tap to choose 🙂", with the button "Choose what I send you". Eleni's screen shows only his question. |
| 2 | 0:20 | Nikos | Tap "Choose what I send you", then Start. Tap "Family moments now and then" and "Talk to me by voice", then "Done". | Anchor says that it is not a person, and each choice turns ✅ in place. After "Done", Anchor answers with a voice note: "All set 💛". |
