...
The 6-minute presentation is one story: the problem, a day in Nikos's family with Anchor, and the close. The live part shows Anchor v2: no commands, every member chooses what Anchor sends them, a share offer, a reminder offer, and voice both ways. The phone call is the stretch goal.
...
| Nikos, the grandfather | Teammate 3 | Phone 2, the family group, then his private chat with Anchor. Speaks in character. |
...
Each beat names the action, the spoken lines, and what the audience sees. The times include about 5 seconds of model latency per beat, so a speaker talks while Anchor works. With beat 7, the run ends at about 5:25. Without beat 7, the run ends at about 4:25.

### The problem (0:00, Narrator)

> This is Nikos. He lives on his own, and he likes it that way. His family lives in a group chat: photos, plans, and jokes, all day long. By the time Nikos finds his glasses, the photos of his granddaughter are buried under forty new messages. He doesn't type well, and he doesn't want to be a burden, so he stops asking. Slowly, he drops out of his own family's story.
>
...
| --- | --- | --- | --- | --- | --- |
| 1 | 0:40 | Nikos | In the group, write "Anchor, can you send me family photos?" | Nikos, before: "Where are Maria's photos? I'll just ask." Narrator, after: "No command, no new app. Nikos asks in his own words, and only he sees the answer." | Only Nikos sees Anchor's answer: "Nikos, I can send you family moments, reminders, and voice notes in private. Tap to choose 🙂", with the button "Choose what I send you". Eleni's screen shows only his question. |
| 2 | 1:00 | Nikos | Tap "Choose what I send you", then Start. Tap "Family moments now and then" and "Talk to me by voice", then "Done". | Nikos: "Voice? Good. I'd rather talk than type." | Anchor says that it is not a person, and each choice turns ✅ in place. After "Done", Anchor answers with a voice note: "All set 💛". |
| 3 | 1:35 | Eleni | Post the photo with the caption "Maria's first day of school! She wore her new red backpack." | Eleni, before: "Maria's first day of school. Dad has to see this." | Anchor reacts with ❤. Only Eleni sees "Shall I send this to Nikos now?". She taps "Yes, send it", and the offer turns into "Sent to Nikos 💛". |
| 4 | 2:00 | Nikos, then Eleni | In private, play the voice note, then answer with a voice note of about 10 seconds: "My first day was in 1958. My mother walked me to the village school, and I cried at the gate." Tap "Yes, share it". | Eleni, after the group post: "Dad, you never told me that. Maria has to hear this." Narrator: "Nikos isn't the one being helped here. He gives the family a story only he can tell." | Nikos gets the photo, then a voice note: "Eleni shared: «Maria's first day of school! …» What does it remind you of?". Anchor thanks him by voice. In the group: "Nikos added a story to Eleni's moment 🎙️", with his words, his voice note, and a big ❤. |
| 5 | 2:50 | Eleni | In the group, reply to Nikos's message of beat 1 with "Dad, remember to take your pills with you when we leave in the morning." | Eleni, after the ✍: "And I don't have to nag him in front of everyone." | Only Nikos sees "⏰ Eleni wrote: «Dad, remember to take your pills…» Shall I remind you?", with "Yes, at 08:00", "Another time", "No thanks", and "Stop offering reminders". He taps "Yes, at 08:00". The offer turns into "Done ✍ I'll remind you at 08:00 in our private chat.", and Eleni's message gets a ✍. The family sees only the ✍. |
...
- No reminder offer for Nikos in beat 5 after 10 seconds: Eleni writes "Dad, don't forget your pills tomorrow at 8." If no offer comes again, the Narrator tells beats 5 and 6 in one sentence each, and the story continues with beat 7 or the close.
...
- "I couldn't ring you just now" in beat 7, or no ring after 15 seconds: the Narrator says "The phone call is our next step", and the Closer starts the close.
- The call rings, but Anchor stays silent for 5 seconds: Nikos hangs up. The Narrator says "The phone call is our next step", and the Closer starts the close.
...
3. If the run without beat 7 takes more than 4:30, shorten the spoken lines first.
